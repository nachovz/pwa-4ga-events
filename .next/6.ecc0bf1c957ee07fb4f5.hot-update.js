...
function (_Component) {
  ...
  function Event(props) {
    ...
    _this.actions = {
      loadApiData: function loadApiData() {
        fetch('https://assets.breatheco.de/apis/event/' + _this.props.id).then(function (response) {
  ...
  _createClass(Event, [{
    ...
    value: function render() {
      ...
      if (event.event_date !== null && _typeof(event.event_date) !== undefined) {
      ...
      }, __WEBPACK_IMPORTED_MODULE_22_react_html_parser___default()(event.description.replace(/<br>/g, '')))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__material_ui_core_CardActions___default.a, {
...
//# sourceMappingURL=6.ecc0bf1c957ee07fb4f5.hot-update.js.map